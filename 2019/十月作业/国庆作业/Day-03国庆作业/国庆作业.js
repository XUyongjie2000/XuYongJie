...
// if(member == 'y'){
//     if(money>=200){
//         console.log("您实际应付的金额为"+money*0.75);
//     }else{
//         console.log("您实际应付的金额为"+money*0.8);
        
//     }
// }else{
//     if(money>=100){
//         console.log("您实际的应付金额为"+money*0.9);
//     }else{
//         console.log("您应付的金额为"+money);
//     }
...
// // console.log(1+'false')   输出结果是 1false  false是字符串  所以+号起到拼接字符串的作用 所以打印结果是1false
// // console.log(1+false)     输出结果是 1       false是一个布尔值  需要先转换为数字 false转换为数字是0  因为1+0=1  所以输出1